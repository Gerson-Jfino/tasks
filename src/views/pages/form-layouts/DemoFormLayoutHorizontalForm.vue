...
const submit = () => {
  ...
  //formData.append("document", form.document)
  api.post("/activities", formData, config)
    .then((res) => {
      Swal.fire({
        icon: 'success',
    ...
    <VCol cols="12">
      <VForm class="mt-6">
        <VRow>
          ...
          <VCol md="4" cols="12">
            <VSelect label="Estado" :items="status" item-title="name" item-value="id" v-model="form.status_id" />
          </VCol>
          <VCol md="4" cols="12">
            <VSelect label="Solicitante" :items="uns" item-title="name" item-value="value" v-model="form.owner" />
          </VCol>
          <VCol md="4" cols="12">
            <VSelect label="Tipo de actividade" :items="tipos" item-title="name" item-value="value"
              v-model="form.tipo_actividade" />
          </VCol>

          <VCol md="6" cols="12">
            <VTextField label="Data de inicio" type="date" placeholder="DD/MM/YYYY" v-model="form.start_date" />
          </VCol>
          <VCol md="6" cols="12">
            <VTextField label="Data prevista" type="date" placeholder="DD/MM/YYYY" v-model="form.due_date" />
          </VCol>
          <VCol md="6" cols="12">
            <VTextField label="Data final" type="date" placeholder="DD/MM/YYYY" v-model="form.final_date" />
          </VCol>
          <VCol md="6" cols="12">
            <VTextField label="Anexo" type="file" @change="handleFileChange" v-model="form.document" />
          </VCol>
          <VCol md="12" cols="12">
